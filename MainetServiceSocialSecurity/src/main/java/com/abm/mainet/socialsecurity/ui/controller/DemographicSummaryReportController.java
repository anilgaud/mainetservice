...
public class DemographicSummaryReportController extends AbstractFormController<DemographicSummaryReportModel> {
	...
	public @ResponseBody String viewForm(@RequestParam("pSchedule") Long pSchedule,
		...
		return ServiceEndpoints.LEGAL_CASE_BIRT_REPORT_URL + "=DemographicSummaryReport.rptdesign&OrgId=" + currentOrgId
				+ "&PenSchedule=" + pSchedule + "&PenSchemeName=" + pSchemeName + "&FromDate=" + fromdt + "&ToDate="
				+ todt;
	}
}
